           ...
           ext2fs_generic_bitmap bmap)
{
 ...
 if (!bmap)
  return (2133571399L);
 if ((bmap)->magic != ((2133571338L))) return ((2133571338L));
 if (new_end > bmap->end) {
  bitno = bmap->real_end;
  if (bitno > new_end)
   bitno = new_end;
         ...
         ext2fs_inode_bitmap bmap)
{
 ...
 if (!bmap)
  return (2133571399L);
 if ((bmap)->magic != ((2133571337L))) return ((2133571337L));
 bmap->magic = (2133571338L);
 retval = ext2fs_resize_generic_bitmap(new_end, new_real_end,
           bmap);
 bmap->magic = (2133571337L);
 return retval;
}
         ...
         ext2fs_block_bitmap bmap)
{
 ...
 if (!bmap)
  return (2133571399L);
 if ((bmap)->magic != ((2133571336L))) return ((2133571336L));
 bmap->magic = (2133571338L);
 retval = ext2fs_resize_generic_bitmap(new_end, new_real_end,
           bmap);
 bmap->magic = (2133571336L);
 return retval;
}
