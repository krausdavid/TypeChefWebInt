...
{
 blk_t i;
 if ((bm1)->magic != ((2133571336L))) return ((2133571336L));
 if ((bm2)->magic != ((2133571336L))) return ((2133571336L));
...
{
 ext2_ino_t i;
 if ((bm1)->magic != ((2133571337L))) return ((2133571337L));
 if ((bm2)->magic != ((2133571337L))) return ((2133571337L));
 if ((bm1->start != bm2->start) ||
     (bm1->end != bm2->end) ||
     (memcmp(bm1->bitmap, bm2->bitmap,
      (size_t) (bm1->end - bm1->start)/8)))
