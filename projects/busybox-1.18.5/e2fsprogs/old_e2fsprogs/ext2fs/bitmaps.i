        ...
        ext2fs_generic_bitmap *ret)
{
 ...
 if (retval)
  return retval;
 bitmap->magic = (2133571338L);
 bitmap->fs = ((void *)0);
 bitmap->start = start;
 bitmap->end = end;
 bitmap->real_end = real_end;
 bitmap->base_error_code = (2133571389L);
 if (descr) {
           ...
           ext2fs_inode_bitmap *ret)
{
 ...
 real_end = (((fs->super)->s_inodes_per_group) * fs->group_desc_count);
 retval = ext2fs_allocate_generic_bitmap(start, end, real_end,
      descr, &bitmap);
 if (retval)
  return retval;
 bitmap->magic = (2133571337L);
 bitmap->fs = fs;
 bitmap->base_error_code = (2133571376L);
 *ret = bitmap;
 return 0;
}
           ...
           ext2fs_block_bitmap *ret)
{
 ...
 real_end = (((fs->super)->s_blocks_per_group)
      * fs->group_desc_count)-1 + start;
 retval = ext2fs_allocate_generic_bitmap(start, end, real_end,
      descr, &bitmap);
 if (retval)
  return retval;
 bitmap->magic = (2133571336L);
 bitmap->fs = fs;
 bitmap->base_error_code = (2133571373L);
 *ret = bitmap;
 return 0;
}
errcode_t ext2fs_fudge_inode_bitmap_end(ext2fs_inode_bitmap bitmap,
     ext2_ino_t end, ext2_ino_t *oend)
{
 if ((bitmap)->magic != ((2133571337L))) return ((2133571337L));
...
errcode_t ext2fs_fudge_block_bitmap_end(ext2fs_block_bitmap bitmap,
     blk_t end, blk_t *oend)
{
 if ((bitmap)->magic != ((2133571336L))) return ((2133571336L));
 if (end > bitmap->real_end)
  return (2133571379L);
 if (oend)
  *oend = bitmap->end;
...
{
 if (!bitmap || (bitmap->magic != (2133571337L)))
  return;
...
{
 if (!bitmap || (bitmap->magic != (2133571336L)))
  return;
 memset(bitmap->bitmap, 0,
        (size_t) (((bitmap->real_end - bitmap->start) / 8) + 1));
}
