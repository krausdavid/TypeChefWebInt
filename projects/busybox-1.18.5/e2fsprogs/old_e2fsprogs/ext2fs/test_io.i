...
static errcode_t test_open(const char *name, int flags, io_channel *channel)
{
 ...
 struct test_private_data *data = ((void *)0);
 errcode_t retval;
 char *value;
 if (name == 0)
  return (2133571386L);
 ...
 data->outfile = ((void *)0);
 if ((value = getenv("TEST_IO_LOGFILE")) != ((void *)0))
  data->outfile = fopen_for_write(value);
 if (!data->outfile)
  data->outfile = stderr;
 data->flags = 0;
 if ((value = getenv("TEST_IO_FLAGS")) != ((void *)0))
  data->flags = strtoul(value, ((void *)0), 0);
 data->block = 0;
 if ((value = getenv("TEST_IO_BLOCK")) != ((void *)0))
  data->block = strtoul(value, ((void *)0), 0);
 data->read_abort_count = 0;
 if ((value = getenv("TEST_IO_READ_ABORT")) != ((void *)0))
  data->read_abort_count = strtoul(value, ((void *)0), 0);
 data->write_abort_count = 0;
 if ((value = getenv("TEST_IO_WRITE_ABORT")) != ((void *)0))
  data->write_abort_count = strtoul(value, ((void *)0), 0);
 *channel = io;
 return 0;
cleanup:
 ext2fs_free_mem(&io);
...
static errcode_t test_close(io_channel channel)
{
 struct test_private_data *data;
 errcode_t retval = 0;
 if ((channel)->magic != ((2133571333L))) return ((2133571333L));
 data = (struct test_private_data *) channel->private_data;
 if ((data)->magic != ((2133571339L))) return ((2133571339L));
 if (--channel->refcount > 0)
  return 0;
 if (data->real)
  retval = ((data->real)->manager->close((data->real)));
...
static errcode_t test_set_blksize(io_channel channel, int blksize)
{
 ...
 if ((data)->magic != ((2133571339L))) return ((2133571339L));
 if (data->real)
  retval = ((data->real)->manager->set_blksize((data->real),blksize));
 if (data->set_blksize)
          ...
          int count, void *buf)
{
 ...
 if ((data)->magic != ((2133571339L))) return ((2133571339L));
 if (data->real)
  retval = ((data->real)->manager->read_blk((data->real),block,count,buf));
 if (data->read_blk)
          ...
          int count, const void *buf)
{
 ...
 if ((data)->magic != ((2133571339L))) return ((2133571339L));
 if (data->real)
  retval = ((data->real)->manager->write_blk((data->real),block,count,buf));
 if (data->write_blk)
...
static errcode_t test_flush(io_channel channel)
{
 ...
 if ((data)->magic != ((2133571339L))) return ((2133571339L));
 if (data->real)
  retval = ((data->real)->manager->flush((data->real)));
 if (data->flags & 0x08)
