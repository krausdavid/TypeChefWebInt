       ...
       char **devname)
{
 ...
 int dirlen;
 struct stat st;
 if ((dir = opendir(dir_name)) == ((void *)0))
  return;
 ...
 while ((dp = readdir(dir)) != 0) {
  ...
  else if (((((st.st_mode)) & 0170000) == (0060000)) && st.st_rdev == devno) {
...
const char *blkid_devdirs[] = { "/devices", "/devfs", "/dev", ((void *)0) };
char *blkid_devno_to_devname(dev_t devno)
{
 struct dir_list *list = ((void *)0), *new_list = ((void *)0);
 char *devname = ((void *)0);
 const char **dir;
